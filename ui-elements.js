...
(function () {
    const SECTION_META = {
        ...
        'buy-services': { label: 'Service Catalog', group: 'Invoices' },
        ...
        'portal-logins': { label: 'Portal Login Credentials', group: 'Documents' },
        'gst-calculator': { label: 'GST Overview', group: 'GST & Compliance' },
        'hsn-search': { label: 'Invoice Compliance', group: 'GST & Compliance' },
        'bank-recon': { label: 'Bank Statement Reconciliation', group: 'Banking' },
        'emi-calculator': { label: 'EMI Calculator', group: 'GST & Compliance' },
        'income-computation': { label: 'Income Computation', group: 'GST & Compliance' },
        'itr-json-pdf': { label: 'ITR JSON to PDF', group: 'GST & Compliance' },
        'gstr-export': { label: 'GSTR Return Export', group: 'GST & Compliance' },
