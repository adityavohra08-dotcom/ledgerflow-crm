...
(function () {
    ...
    const FEATURES = [
        ...
        { id: 'cap-gstr-filing', pillar: 'gst', name: 'GSTR-1, GSTR-3B, GSTR-9 filing', status: 'partial', type: 'list', dataKey: 'gstrFilings', icon: 'fa-file-export',
          route: "showSection('cap-gstr-filing')", cols: ['return', 'period', 'status', 'filedOn', 'arn'],
        ...
        { id: 'cap-gstr2b', pillar: 'gst', name: 'GSTR-2B reconciliation', status: 'partial', type: 'list', dataKey: 'gstr2bRecon', icon: 'fa-code-compare',
          route: "showSection('cap-gstr2b')", cols: ['supplier', 'invoice', 'booksItc', 'gstr2bItc', 'match'],
    ...
    const LIVE_LINKS = [
        ...
        { pillar: 'banking', name: 'Fast bank reconciliation', route: "showSection('bank-recon')", status: 'partial' },
